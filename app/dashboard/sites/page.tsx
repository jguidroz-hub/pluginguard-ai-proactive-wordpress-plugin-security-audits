...
export default function SitesPage() {
  const [items, setItems] = useState<SitesItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Monitored WordPress Sites</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Manage and track WordPress installations</p>
