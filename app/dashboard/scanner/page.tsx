...
export default function FeaturePage() {
  const items = [
    { t: "🔴 Contact Form 7 (v5.7)", d: "CVE-2025-1234 • RCE vulnerability • CVSS: 9.8 • Update to v5.8.1", s: "critical" },
    { t: "🟡 WooCommerce (v8.4)", d: "CVE-2025-5678 • XSS in admin panel • CVSS: 5.4 • Update to v8.5", s: "medium" },
    { t: "🟢 Yoast SEO (v22.1)", d: "No known vulnerabilities • Last checked: 2 min ago", s: "safe" },
    { t: "🟢 WP Rocket (v3.15)", d: "No known vulnerabilities • Last checked: 2 min ago", s: "safe" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Vulnerability Scanner</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Scan WordPress plugins for known CVEs</p>
