...
export default function DetailedAuditPage() {
  ...
  useEffect(() => {
    fetch('/api/report/detailed-audit')
      .then(r => r.json())
  ...
  const handleCreate = async () => {
    ...
    const res = await fetch('/api/report/detailed-audit', {
      method: 'POST',
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/report/detailed-audit/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Comprehensive Security Report</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">In-depth analysis of plugin vulnerabilities</p>
